...
describe('Testes da função getOpeningHours', () => {
  it('Não passando argumentos a função deve retornar um objeto específico', () => {
    const expected = {
  ...
  it('Para os argumentos  deve lançar uma exceção com a mensagem: The hour should represent a number', () => {
    expect(() => getOpeningHours('Saturday', '13:00-AM')).toThrow('The hour must be between 0 and 12');
  });

  it('Para os argumentos  deve lançar uma exceção com a mensagem: The minutes should represent a number', () => {
